...
public class StartMenu extends JFrame implements ActionListener {
	...
	private JButton B3;
	private JButton B4;
	private JButton B1Options = newButton("Back");
	private JLabel T1Options  = newLabel("Gravity (in G) :");
	private JTextField T2Options;
	public JButton B1Niveau = newButton("Level 1");
	public JButton B2Niveau = newButton("Level 2");
	public JButton B3Niveau = newButton("Level 3");
	public JButton B4Niveau = newButton("Level 4");
	public JButton B5Niveau = newButton("Level 5");
	public JButton B6Niveau = newButton("Level 6");
	public JButton BRNiveau = newButton("Back");
	private JButton B1Regles = newButton("Back");
	...
	private JLabel tailleLabel = newLabel("Bird size :");
	private JLabel tailleLabel0 = newLabel("Small");
	private JLabel tailleLabel1 = newLabel("Medium");
	private JLabel tailleLabel2 = newLabel("Large");
	private JLabel poidsLabel = newLabel("Bird weight :");
	private JLabel poidsLabel0 = newLabel("Light");
	private JLabel poidsLabel1 = newLabel("Medium");
	private JLabel poidsLabel2 = newLabel("Heavy");
	private JLabel typeLabel = newLabel("Structure Type :");
	private JLabel typeLabel0 = newLabel("Straw");
	private JLabel typeLabel1 = newLabel("Wood");
	private JLabel typeLabel2 = newLabel("Concrete");
	...
	private JLabel titleRegles = newLabel("Rules :");
	private JLabel L1Regles = newLabel("The goal of Angry Birds is to use a slingshot ");
	private JLabel L2Regles = newLabel("to send a bird onto structures containing");
	private JLabel L3Regles = newLabel("enemies, and eliminate as many as possible !");
	private JLabel L4Regles = newLabel("To play, simply launch a level, click");
	private JLabel L5Regles = newLabel("on the bird, pull it back, then");
	private JLabel L6Regles = newLabel("it will be launched when you release the mouse.");
	private JLabel L7Regles = newLabel("To pass a level, simply eliminate all");
	private JLabel L8Regles = newLabel("enemies.");
	private JLabel L9Regles = newLabel("Good luck!");
	private JLabel titleInfos = newLabel("Informations");
	private JLabel L1Info = newLabel("By accessing the Options menu, it is possible");
	private JLabel L2Info = newLabel("to customize this game as you see fit:");
	private JLabel L3Info = newLabel("Gravity: Changes the gravity for all objects");
	private JLabel L4Info = newLabel("Size: Changes the size and weight of the bird");
	private JLabel L5Info = newLabel("Type: Changes the density of structures");
	private JLabel L6Info = newLabel("Weight: Changes the density of the bird");
	private JLabel L7Info = newLabel("Game Created for Fun Project");
	...
	public void actionPerformed (ActionEvent e){
		...
		// Bouton pour aller dans les r�gles
		...
		// Bouton de retour dans les r�gles
